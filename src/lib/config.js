 ...
 * 컷 하나가 실제로 57원이고, 8컷 한 편이 741원이다(Y9 §1). 게임 쪽 상수와 달리
...
export const YOURSTORY = {
  ...
  CUT_TIERS: [8, 12, 16],
  // 8컷만 630원이던 것을 741원으로 올렸다(2026-08-13). 상한은 **필수 + 재생성 여유**인데
  // 8컷만 여유가 1회였다 — 12컷 3회 · 16컷 4회에 견줘 혼자 빠듯했다.
  //   필수 (앵커 2 + 컷 8) × 57 = 570원 · 재생성 3회 171원 → 741원
  // 파일럿 0813-0001 이 그 1회 때문에 8컷을 다 그리고도 마감에서 막혔다.
  COST_KRW: { 8: 741, 12: 970, 16: 1255 },
   ...
   *
   * 주문 단위 상한(COST_KRW)만으로는 **폭주를 못 막는다.** 한 건이 741원을 지켜도
   * 하루 400건이 들어오면 30만 원이다. 그래서 상한이 3중이다 — 주문·일·월.
