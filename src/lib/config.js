...
export const YS_ENTRY_TEXT = {
  ...
  ys2: {
    ...
    name: "너의스토리2",
    /**
     * ⚠ **비어 있는 것이 맞다 — 기획에 요청해 둔 자리다** (지시서 14 §1-4
     * 「문안 초안이 필요하면 기획에 요청하라 · 지어내지 마라」).
     *
     * 채우고 싶은 유혹이 있는 칸이다. 한 줄이면 되고 그럴듯하게 쓸 수도 있다.
     * 그러나 소개 문장은 **무엇을 파는지에 대한 약속**이라, 화면을 채우려고
     * 지어내면 아무도 승인하지 않은 약속이 실서비스에 선다.
