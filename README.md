...
**아케이드 10종** — 기획서 [`docs/arcade-10-games.md`](docs/arcade-10-games.md) 기준.
...
아케이드 10종의 광고 트리거는 게임마다 3종으로 같습니다 —
...
│   ├── index.html           허브 (오리지널 4종 + 아케이드 10종)
│   ├── shared/              공통 모듈
│   │   ├── base.css         디자인 시스템
│   │   ├── api.js           API 호출 래퍼
...
│   ├── routes/              세션·광고·통계 라우트
│   └── lib/                 설정·암호화·DB·검증 유틸
│       └── arcade.js        아케이드 런 엔진 (신규)
├── migrations/              D1 스키마 + 문장 시드
├── docs/
│   └── arcade-10-games.md   아케이드 10종 기획서
├── scripts/
...
게임이 14개로 늘었지만 **연동 작업량은 그대로 두 파일**입니다. 아케이드 10종의 트리거는
