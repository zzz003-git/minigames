...
### `15e195b` CHANGELOG 갱신 (기준 99c96e9)
> **대조군 영향** — 게임 문서
...
- `docs/handoff/2026-08-14_인프라분리_09_조사판단.md`
- `docs/handoff/2026-08-21_변경이력내보내기_01_조사요청.md`
- `docs/handoff/2026-08-21_변경이력내보내기_02_개발답변.md`

### `502721a` CHANGELOG 갱신 (기준 24af5a4)
> **대조군 영향** — 게임 문서

- `docs/CHANGELOG.md`

### `24af5a4` push 절차에 CHANGELOG 갱신을 넣는다

- `CLAUDE.md`

### `31121e0` CHANGELOG 갱신 (기준 8759b31)
> **대조군 영향** — 게임 문서
